		...
		function apply(ctx) {
			...
			ctx.slots.inject("conversation.input.model", () => ctx.slots.register({
				...
				*/
				...
				react.useEffect(() => {
					...
					const measure = () => {
						if (trackRef.current !== null) {
							...
							setGrid((g) => g !== null && g.c === next.c && g.r === next.r && g.sq === next.sq && g.gap === next.gap && g.padTop === next.padTop && g.padBottom === next.padBottom && g.padLeft === next.padLeft && g.padRight === next.padRight ? g : next);
						}
					};
					measure();
				...
				}, react.createElement("div", { className: "sk5-modelsTitle" }, tr("menu.models")), react.createElement("div", { className: "sk5-list" }, data === null && error === null ? react.createElement("div", { className: "sk5-status" }, tr("status.loading")) : null, data === null && error !== null ? react.createElement("div", { className: "sk5-err" }, error) : null, data !== null && groups.length === 0 ? react.createElement("div", { className: "sk5-status" }, tr("status.noModels")) : null, data !== null ? groups.map((g) => react.createElement("div", { key: g.id }, react.createElement("div", { className: "sk5-group" }, g.name), g.models.map((m) => {
				...
				}, "?"), react.createElement("div", { className: "sk5-helpTip" }, react.createElement("div", { className: "sk5-helpTitle" }, tr("effort.title")), react.createElement("div", { className: "sk5-helpText" }, tr("help.text"))))), react.createElement("div", { className: "sk5-labelsRow" }, react.createElement("span", { className: "sk5-endLabel" }, "Faster"), react.createElement("span", { className: "sk5-endLabel" }, "Smarter")), react.createElement("div", {
					ref: trackRef,
					className: "sk5-track",
				...
				}, react.createElement("span", { className: "sk5-dot" + (i === choices.length - 1 ? " sk5-dotMax" : "") }))) : null, react.createElement("div", {
